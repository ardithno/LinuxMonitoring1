function output {
    ...
    echo
    echo -e "Column 1 background = $bg1 (${arr_name_col[0]})"
    echo -e "Column 1 font color = $f1 (${arr_name_col[1]})"
    echo -e "Column 2 background = $bg2 (${arr_name_col[2]})"
    echo -e "Column 2 font color = $f2 (${arr_name_col[3]})"
